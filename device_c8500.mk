...
PRODUCT_COPY_FILES += \
    ...
    device/huawei/c8500/prebuilt/installlogo:system/media/installlogo \
    device/huawei/c8500/prebuilt/media/oemlogo.mbn:system/media/oemlogo.mbn

#  Add autorun.iso to stop kernel complaining about it..
PRODUCT_COPY_FILES += \
    device/huawei/c8500/prebuilt/autorun.iso:system/cdrom/autorun.iso
...
PRODUCT_COPY_FILES += \
    ...
    device/huawei/c8500/prebuilt/lib/modules/ramzswap.ko:system/lib/modules/ramzswap.ko \
...
PRODUCT_COPY_FILES += \
    ...
    device/huawei/c8500/gps.conf:system/etc/gps.conf

# enhanced.conf
PRODUCT_COPY_FILES += \
    device/huawei/c8500/enhanced.conf:system/etc/enhanced.conf
